<template>
    ...
    <AppLayout>
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 ml-mr-1 slide-up" style="animation-delay: 150ms">
                <StatCard 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 ml-mr-1 slide-up" style="animation-delay: 200ms">
                <!-- Últimas questões -->
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 ml-mr-1 slide-up" style="animation-delay: 250ms">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <button @click="$inertia.visit(route('questions.create'))"
                    ...
                    <button @click="$inertia.visit(route('exams.create'))"
                    ...
                    <button @click="$inertia.visit(route('documents.create'))"
