                ...
                <div v-else class="space-y-2">
                    <div v-for="topic in filteredTopics" :key="topic.id"
                        ...
                        <div class="flex items-center gap-1 ml-4">
                            ...
                            <BaseButton variant="outline" size="sm" icon-only :aria-label="`Excluir tópico: ${topic.name}`"
                                        class="!text-red-600 !border-red-300 hover:!bg-red-50" @click="deleteTopic(topic)">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
